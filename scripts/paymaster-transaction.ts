...
const ZEEK_MESSAGES_CONTRACT_ADDRESS = "0x25E87469eF89d9665A2A91C321474628fac565CB";
// Address of the ERC20 token contract
const TOKEN_CONTRACT_ADDRESS = "0x78a9AB3005b588C89FeC520e7229430aF50049cf";
...
// Note that the script needs the ABI which is generated from the compilation artifact.
  ...
  const messagesContractArtifactsPath = `browser/contracts/artifacts/ZeekMessages.json`;
